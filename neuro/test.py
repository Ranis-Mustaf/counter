...
session = ort.InferenceSession("C:/Users/mustafin_rf/runs/detect/train21/weights/best.onnx")  # Укажите путь к вашей модели

# Загрузка изображения
image = cv2.imread('C:/Users/mustafin_rf/Desktop/neuro/dataset/test/images/2.jpg')  # Укажите путь к вашему изображению
